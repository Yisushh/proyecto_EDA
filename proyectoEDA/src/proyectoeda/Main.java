...
class Main {
    public static void main(String[] args) {
        ...
        // -------------------- Individuos
        Lista_individuo individuo1 = new Lista_individuo("A", "recesivo");
        individuo1.agregarFrente(ojos[0]);
        individuo1.agregarFrente(gruposSangre[0]);
        individuo1.agregarFrente(predisposicion[0]);

        Lista_individuo individuo2 = new Lista_individuo("B", "dominante");
        ...
        Lista_individuo individuo5 = new Lista_individuo("E", "recesivo");
